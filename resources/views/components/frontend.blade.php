...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="logo/favicon.jpg" type="{{ asset('image/gif')}}" sizes="16x16">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li>
                    <a href="#"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti">3</span>
                    </a>
                </li>
            </ul>
            <a href="">
                <div class="header__cart__price">
                    item: <span class="shoppingcartTotal">$150.00</span>
                </div>
            </a>
        </div>
                ...
                <li><a href="#"> Merchants </a>
                    <ul class="header__menu__dropdown">
                      @foreach($data[0] as $brand)
                        <li><a href="./blog-details.html">{{ $brand->name }}</a></li>
                      @endforeach
                    </ul>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li>
                                <a href="#"><i class="fa fa-shopping-bag"></i> <span class="shoppingcartNoti">3</span></a>
                            </li>
                        </ul>
                        <a href="">
                            <div class="header__cart__price">item: <span class="shoppingcartTotal">$150.00</span></div>
                        </a>
                    </div>
                </div>
            </div>
