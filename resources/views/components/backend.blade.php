    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="{{ route('backside.brand.index') }}">
                ...
                <li>
                    <a class="app-menu__item" href="{{ route('backside.item.index') }}">
                ...
                <li>
                    <a class="app-menu__item" href="{{ route('backside.subcategory.index') }}">
        ...
        {{ $slot }}  {{-- template main ko a lal htl htae ag lope tr --}}
